<template>
    <el-card>
        <el-form :inline="true" class="form">
            <el-form-item label="设备搜索">
                <el-input placeholder="请你输入搜索设备关键字" v-model="keyword"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-card style="margin: 10px 0px;">
        <el-button type="primary" size="default" icon="Plus" @click="addRole">添加设备</el-button>
        <el-table border style="margin: 10px 0px;" :data="allRole">
            <el-table-column type="index" align="center" label="#"></el-table-column>
            <el-table-column label="设备ID" align="center" prop="id"></el-table-column>
            <el-table-column label="绑定用户" align="center" prop="username" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="定位更新时间" align="center" show-overflow-tooltip prop="updateTime"></el-table-column>
            <el-table-column label="操作" width="280px" align="center">
                <!-- row:已有的职位对象 -->
                <template #="{ row, $index }">
                    <el-button type="primary" size="small" icon="User" @click="setPermisstion(row)">分配设备</el-button>
    ...
    <!-- 添加职位与更新已有职位的结构:对话框 -->
    <el-dialog v-model="dialogVisite" :title="RoleParams.id ? '更新设备' : '添加设备'">
        <el-form :model="RoleParams" :rules="rules" ref="form">
            <el-form-item label="设备号" prop="id">
                <el-input placeholder="请正确输入设备号" v-model="RoleParams.roleName"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
