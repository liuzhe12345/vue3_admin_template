<template>
    ...
    <el-card style="margin: 10px 0px;">
        <el-button type="primary" size="default" @click="addUser">自动分配</el-button>
        ...
        <el-table @selection-change="selectChange" style="margin: 10px 0px;" border :data="userArr">
            ...
            <el-table-column label="宿舍楼栋" align="center" prop="buildings"></el-table-column>
            <el-table-column label="门牌号" align="center" prop="doorplate"></el-table-column>
            <el-table-column label="住户名字" align="center" prop="username" show-overflow-tooltip></el-table-column>
            <el-table-column label="住户性别" align="center" prop="sex" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row, $index }">
                    <el-button type="primary" size="small" icon="User" @click="setRole(row)">更换宿舍</el-button>
    ...
    <el-drawer v-model="drawer">
        ...
        <template #default>
            <el-form :model="userParams" :rules="rules" ref="formRef">
                <el-form-item label="宿舍楼栋" prop="username">
                    <el-input placeholder="请您输入宿舍楼栋" v-model="userParams.username"></el-input>
                </el-form-item>
                <el-form-item label="门牌号" prop="roleName">
                    <el-input placeholder="请您输入门牌号" v-model="userParams.password"></el-input>
                </el-form-item>
                <el-form-item label="人数选择" prop="sex">
                    <el-select v-model="userParams.sex" placeholder="请选择寝室人数">
                        ...
                        <el-option label="五人间" value="5"></el-option>
        ...
        <template #footer>
            <div style="flex: auto">
                ...
                <el-button type="primary" @click="save">自动分配</el-button>
            </div>
        </template>
    </el-drawer>
