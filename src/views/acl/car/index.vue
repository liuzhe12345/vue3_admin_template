<template>
  ...
  <el-card style="margin: 10px 0px;">
      ...
      <el-table @selection-change="selectChange" style="margin: 10px 0px;" border :data="userArr">
          ...
          <el-table-column label="车牌号" align="center" prop="doorplate"></el-table-column>
          <el-table-column label="乘客名字" align="center" prop="username" show-overflow-tooltip></el-table-column>
          <el-table-column label="乘客班级" align="center" prop="classnumber" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column label="操作" width="300px" align="center">
              <template #="{ row, $index }">
                  <el-button type="primary" size="small" icon="User" @click="setRole(row)">更换车辆</el-button>
      ...
      <template #default>
          <el-form :model="userParams" :rules="rules" ref="formRef">
              <el-form-item label="车牌号" prop="username">
                  <el-input placeholder="请您输入车牌号" v-model="userParams.username"></el-input>
              </el-form-item>
              <el-form-item label="载客数" prop="roleName">
                  <el-input placeholder="请您输入载客数" v-model="userParams.password"></el-input>
              </el-form-item>
